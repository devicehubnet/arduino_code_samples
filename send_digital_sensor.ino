/*
DeviceHUB.net sample code for sending an digital sensor.
...
char sensorTopic[]    = "/a/"API_KEY"/p/"PROJECT_ID"/d/"DEVICE_UUID"/sensor/"DI_SENSOR_NAME"/data";
...
void sendData(void) 
{
  ...
  if(conn) 
  {
    ...
    if (millis() > (time + 5000)) 
    {
      ...
      String pubString = "{\"value\": " + String(digital_sensor) + "}";
